...
O = {
    ...
    # guide
    'how_to': dict(closing_heading='After you finish | What to do next', closing_content='What the reader should check once the steps are done and the one thing that goes wrong most often, in 60 to 120 words. No recap of the steps.', h3_policy='required: one H3 per step or per step group inside the section that walks through the procedure, phrased as the action (verb first).'),
    ...
    'process_page': dict(closing_heading='After the process ends | What to do next', h3_policy='required: one H3 per stage inside the section that walks through the process.'),

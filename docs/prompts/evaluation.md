...
Spec: {"words_min": 1500, "words_max": 3500, "default_words": 2500, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 3, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Article + ItemList + BreadcrumbList"}
...
- Preferred formats for this page type, where a section has no format of its own: table (as a markdown table with a header row), prose (as prose), bullets (as a short bulleted list).
...
Spec: {"words_min": 1500, "words_max": 3000, "default_words": 1800, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 2, "citations_min": 2, "research": "search", "section_format_hints": "table,prose,bullets", "schema_types": "Article + FAQPage + ItemList + BreadcrumbList"}
...
Spec: {"words_min": 1500, "words_max": 3000, "default_words": 1600, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Article + ItemList + BreadcrumbList"}
...
- Opening paragraph: a direct answer of 40 to 80 words in the verdict style (A verdict paragraph that says which option suits whom). No heading above it, no preamble. It answers the question the H1 implies.
- Then these H2 sections, in this exact order, with these exact headings. Do not add, merge, rename or reorder sections. H3 subheadings inside a section are allowed where they help.
  1. First H2 from the app [380 words]
  2. Second H2 from the app [380 words, as a markdown table with a header row]
  3. Third H2 from the app [380 words]
  4. Fourth H2 from the app [380 words]
- Preferred formats for this page type, where a section has no format of its own: table (as a markdown table with a header row), prose (as prose), bullets (as a short bulleted list).
...
Spec: {"words_min": 1000, "words_max": 2000, "default_words": 1500, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "WebPage + FAQPage + BreadcrumbList"}
...
Spec: {"words_min": 1500, "words_max": 3000, "default_words": 2250, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Review + Product + BreadcrumbList"}
...
Spec: {"words_min": 1200, "words_max": 2500, "default_words": 1850, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Article + FAQPage + BreadcrumbList"}
...
Spec: {"words_min": 1000, "words_max": 2000, "default_words": 1500, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Article + FAQPage + BreadcrumbList"}
...
Spec: {"words_min": 1200, "words_max": 2500, "default_words": 1850, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Article + ItemList + BreadcrumbList"}
...
Spec: {"words_min": 1500, "words_max": 3000, "default_words": 2250, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Article + ItemList + FAQPage + BreadcrumbList"}
...
Spec: {"words_min": 1000, "words_max": 2500, "default_words": 1750, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "ItemList + LocalBusiness + BreadcrumbList"}
...
Spec: {"words_min": 1000, "words_max": 2000, "default_words": 1500, "answer_paragraph": true, "answer_style": "verdict", "tables_min": 1, "citations_min": 2, "research": "deep", "section_format_hints": "table,prose,bullets", "schema_types": "Article + HowTo + FAQPage + BreadcrumbList"}

...
const SAFE_LANDSCAPE = 'Keep every important element and all text inside the central 85 percent of the height and away from the bottom-right corner, because the picture is cropped to 16:9 and YouTube overlays the duration there.';
const SAFE_PORTRAIT = 'Vertical composition for a YouTube Short: keep every important element and all text inside the central 80 percent of the width and inside the middle 60 percent of the height, because the sides are cropped to 9:16 and the top and bottom are covered by the Shorts interface.';
